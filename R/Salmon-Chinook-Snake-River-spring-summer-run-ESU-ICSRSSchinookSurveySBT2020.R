...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chinook salmon. Method: Survey. \href{../data/Salmon-Chinook-Snake-River-spring-summer-run-ESU-ICSRSSchinookSurveySBT2020.html}{View raw data} or \href{../data/Salmon-Chinook-Snake-River-spring-summer-run-ESU-ICSRSSchinookSurveySBT2020.csv}{Download raw data}
#' 
#' 
#' @source Shoshone-Bannock Tribe
#' 
#' @references
...
#' 
#' @name Salmon-Chinook-Snake-River-spring-summer-run-ESU-ICSRSSchinookSurveySBT2020
#' @docType data
#' @examples
