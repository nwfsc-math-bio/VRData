...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chum salmon. Method: Survey
#' 
#' 
...
#' 
#' Original source: CAX05262020
#' 
#' @name Salmon chum (Columbia River ESU)
#' @docType data
#' @examples
#' data('Salmon chum (Columbia River ESU)')
#' library(ggplot2)
#' out$NUMBER_OF_SPAWNERS[out$NUMBER_OF_SPAWNERS==-99] <- NA
#' ggplot(out, aes(x=YEAR, y=NUMBER_OF_SPAWNERS)) + geom_point(na.rm = TRUE) +
#'   ggtitle('Salmon chum (Columbia River ESU)') +
