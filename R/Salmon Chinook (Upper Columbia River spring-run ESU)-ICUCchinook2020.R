...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chinook salmon. Method: Survey. \href{../data/Salmon Chinook (Upper Columbia River spring-run ESU)-ICUCchinook2020.html}{View raw data} or \href{../data/Salmon Chinook (Upper Columbia River spring-run ESU)-ICUCchinook2020.csv}{Download raw data}
#' 
#' 
...
#' 
#' @name Salmon Chinook (Upper Columbia River spring-run ESU)-ICUCchinook2020
#' @docType data
#' @examples
