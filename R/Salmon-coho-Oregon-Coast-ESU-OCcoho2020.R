...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Coho salmon. Method: Survey. \href{../data/Salmon-coho-Oregon-Coast-ESU-OCcoho2020.html}{View raw data} or \href{../data/Salmon-coho-Oregon-Coast-ESU-OCcoho2020.csv}{Download raw data}
#' 
#' 
...
#' 
#' @name Salmon-coho-Oregon-Coast-ESU-OCcoho2020
#' @docType data
#' @examples
