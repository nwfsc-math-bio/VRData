...
#' }
#' 
#' @name Snake-River-Spring-Summer-run-Chinook-Salmon-ESU
#' @docType data
#' @examples
#' data('Snake-River-Spring-Summer-run-Chinook-Salmon-ESU')
#' library(ggplot2)
#' out$NUMBER_OF_SPAWNERS[out$NUMBER_OF_SPAWNERS==-99] <- NA
#' ggplot(out, aes(x=YEAR, y=NUMBER_OF_SPAWNERS)) + geom_point(na.rm = TRUE) +
#'   ggtitle('Snake-River-Spring-Summer-run-Chinook-Salmon-ESU') +
