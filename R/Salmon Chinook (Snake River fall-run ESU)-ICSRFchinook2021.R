...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chinook salmon. Method: Survey. \href{../data/Salmon Chinook (Snake River fall-run ESU)-ICSRFchinook2021.html}{View raw data} or \href{../data/Salmon Chinook (Snake River fall-run ESU)-ICSRFchinook2021.csv}{Download raw data}
#' 
#' 
...
#' 
#' @name Salmon Chinook (Snake River fall-run ESU)-ICSRFchinook2021
#' @docType data
#' @examples
