...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Coho salmon. Method: Survey. \href{../data/Salmon-coho-Lower-Columbia-River-ESU-LCcoho2020.html}{View raw data} or \href{../data/Salmon-coho-Lower-Columbia-River-ESU-LCcoho2020.csv}{Download raw data}
#' 
#' 
#' @source
...
#' 
#' @name Salmon-coho-Lower-Columbia-River-ESU-LCcoho2020
#' @docType data
#' @examples
