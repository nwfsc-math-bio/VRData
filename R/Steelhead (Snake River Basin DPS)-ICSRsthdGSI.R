...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Steelhead. Method: GSI
#' 
#' 
...
#' 
#' Original source: CAX051421. Citations with the format CAXMMDDYYYY indicate that the data are from the Coordinated Assessments Partnership (CAP) database and were downloaded on on MM-DD-YYYY. \url{https://www.streamnet.org/home/data-maps/fish-hlis/}.
#' 
