...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Steelhead. Method: Model. \href{../data/Steelhead (Upper Columbia River DPS)-ICUCsthdModel.html}{View raw data} or \href{../data/Steelhead (Upper Columbia River DPS)-ICUCsthdModel.csv}{Download raw data}
#' 
#' 
...
#' 
#' @name Steelhead (Upper Columbia River DPS)-ICUCsthdModel
#' @docType data
#' @examples
