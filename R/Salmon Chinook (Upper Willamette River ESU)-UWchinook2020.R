...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chinook salmon. Method: 
...
#' * Willamette Falls ESC: LadderCount
#' @description Spawner and fraction wild data. Species: chinook. 
#' * North Santiam River: 
#' @description Spawner and fraction wild data. Species: Chinook salmon. 
#' * South Santiam River: 
...
#' * Willamette Falls ESC: pers communication Jamie Anthony
#' * North Santiam River: CAX05262020
#' * South Santiam River: CAX05262020
#' * McKenzie River: CAX05262020
#' * Middle Fork Willamette River: CAX05262020
#' 
