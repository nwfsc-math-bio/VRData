...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chinook salmon. Method: Model. \href{../data/Salmon Chinook (Snake River spring-summer-run ESU)-ICSRSSchinookModel.html}{View raw data} or \href{../data/Salmon Chinook (Snake River spring-summer-run ESU)-ICSRSSchinookModel.csv}{Download raw data}
#' 
#' 
