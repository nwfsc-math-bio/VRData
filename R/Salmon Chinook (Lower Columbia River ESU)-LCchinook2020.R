...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chinook salmon. Method: Survey. \href{../data/Salmon Chinook (Lower Columbia River ESU)-LCchinook2020.html}{View raw data} or \href{../data/Salmon Chinook (Lower Columbia River ESU)-LCchinook2020.csv}{Download raw data}
#' 
#' 
#' @source
