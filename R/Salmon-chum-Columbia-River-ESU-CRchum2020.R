...
#' }
#' 
#' @description Spawner and fraction wild data. Species: Chum salmon. Method: Survey. \href{../data/Salmon-chum-Columbia-River-ESU-CRchum2020.html}{View raw data} or \href{../data/Salmon-chum-Columbia-River-ESU-CRchum2020.csv}{Download raw data}
#' 
#' 
...
#' 
#' @name Salmon-chum-Columbia-River-ESU-CRchum2020
#' @docType data
#' @examples
