---
title: Salmon coho (Oregon Coast ESU)
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Salmon coho (Oregon Coast ESU)}
...
```{r}
data('Salmon coho (Oregon Coast ESU)', package='VRData')
```

## [View raw data](../data/Salmon coho (Oregon Coast ESU).html) &#8212; [Download raw data](../data/Salmon coho (Oregon Coast ESU).csv)
