...
```{r}
data('Salmon Chinook (Puget Sound DPS)', package='VRData')
```

## [View raw data](../data/Salmon Chinook (Puget Sound DPS).html) &#8212; [Download raw data](../data/Salmon Chinook (Puget Sound DPS).csv)
