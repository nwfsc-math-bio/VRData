---
title: Salmon sockeye (Ozette Lake ESU)
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Salmon sockeye (Ozette Lake ESU)}
...
```{r}
data('Salmon sockeye (Ozette Lake ESU)', package='VRData')
```

## [View raw data](../data/Salmon sockeye (Ozette Lake ESU).html) &#8212; [Download raw data](../data/Salmon sockeye (Ozette Lake ESU).csv)
