---
title: Salmon coho (Oregon Coast ESU)-OCcoho2020
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Salmon coho (Oregon Coast ESU)-OCcoho2020}
...
```{r}
data('Salmon coho (Oregon Coast ESU)-OCcoho2020', package='VRData')
```

### [View raw data](../data/Salmon coho (Oregon Coast ESU)-OCcoho2020.html) &#8212; [Download raw data](../data/Salmon coho (Oregon Coast ESU)-OCcoho2020.csv)
